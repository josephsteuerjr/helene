...
const LAYERS: Array<[string, string]> = [
  ["vera.exe — оболочка (Rust, Tauri)", "Окно, значок у часов, уведомления. Сама не думает и не переписывается: собрана один раз и поднимает всё остальное тихими дочерними процессами по vera.json."],
